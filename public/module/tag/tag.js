...
layui.define('jquery', function (exports) {
  ...
  //Form event listening 表单事件监听
  tag.prototype.on = function (events, callback) {
    return layui.onevent.call(this, MOD_NAME, events, callback);
  };

  //External Tags are added 外部Tag新增
  ...
  //The underlying event body 基础事件体
  var call = {
    //Tag
  ...
  //Initialize the element operation 初始化元素操作
